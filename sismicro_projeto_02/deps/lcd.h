...
Copyright (c) 2020 I. Liviu, www.programming-electronics-diy.xyz
...
#define LCD_DATA_PIN					PINB // Used to check busy flag
...
#define LCD_PWM_PIN						PD6 // OC0B pin for backlight brightness control
...
#define LCD_DISPLAY_FLOATS 				TRUE // TRUE or FALSE
...
#define LCD_ANIMATIONS					TRUE 	// TRUE or FALSE
...
*	supported by the LCD module. LCD_CUSTOM_CHARS must be TRUE.
*
